...
export type MediaUnderstandingOutput = Record<string, unknown>;
export type MediaUnderstandingDecision = Record<string, unknown>;

/** Valid message channels for routing. */
export type OriginatingChannelType = string | InternalMessageChannel;
