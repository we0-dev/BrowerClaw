const DEFAULT_TAGLINE = "Minimal local agent runtime for OpenClaw.";
...
const HOLIDAY_TAGLINES = {
  ...
  hanukkah:
    "Hanukkah: Eight nights, eight retries, zero shame - may your terminal stay calm and your builds stay peaceful.",
  halloween:
...
const TAGLINES: string[] = [
  ...
  "Agent online - please keep hands, feet, and appendages inside the shell at all times.",
  ...
  "Context limits exist because even agents need boundaries and good hygiene.",
  ...
  "If you're lost, run help; if you're brave, run build; if you're wise, run tests.",
